...
There are so many code I'm repeating everyday. So I decided to put some of this code to the repo so I can plug it in my projects. Maybe you find it helpful too.
  ...
  s.homepage         = 'https://github.com/Jauzee/HandyExtensions'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Abdurahim Jauzee' => 'jauzee@mail.ru' }
  s.source           = { :git => 'https://github.com/Jauzee/HandyExtensions.git', :tag => s.version.to_s }
  ...
  s.source_files = 'HandyExtensions/**/*'

  s.subspec 'Core' do |core|
    core.source_files = 'HandyExtensions/Core/**/*'
  end

  s.subspec 'Rx' do |rx|
    rx.dependency 'RxSwift', '~> 4.0'
    rx.dependency 'RxCocoa', '~> 4.0'
    rx.source_files = 'HandyExtensions/Rx/**/*'
  end

  s.subspec 'UI' do |ui|
    ui.source_files = 'HandyExtensions/UI/**/*'
  end

  s.subspec 'Foundation' do |fn|
    fn.source_files = 'HandyExtensions/Foundation/**/*'
  end
